# select library if needed (path may needs to be adapted!)
#.libPaths("~/miniconda3/envs/r_env/lib/R/library")
...
load("./data/benchmark_t2m_test_ext.Rdata")

# select parameters for cluster (parameters may need to be adapted!)
registerDoMC(cores = 20)  # you specify the number of cores you want to use here
...
nam <- paste0("./data/results.dvine.lt", lt, ".nw", nw, ".Rdata")
